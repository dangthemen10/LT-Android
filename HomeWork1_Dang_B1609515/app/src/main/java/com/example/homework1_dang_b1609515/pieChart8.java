...
//
    ...
    private void setData8(int count, float range) {
        ...
        double tong4=amount1+amount2+amount3+amount4+amount5+amount6+amount7+amount8;
        double[] yData4={amount1,amount2,amount3,amount4,amount5,amount6,amount7,amount8};
