...
public class PieChartsActivity extends AppCompatActivity {
    ...
    EditText edtDes1, edtDes2, edtDes3, edtDes4, edtDes5, edtDes6, edtDes7, edtDes8,
            edtDes9;
    EditText edttitle;
...
//tổng số liệu nhập vào
                    ...
                    case 5:
                        ...
                        //tính số phần trăm từng phần
                        DecimalFormat df345= new DecimalFormat("0.0");// làm tròn với 3 chữsố thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                    ...
                    case 6:
                        ...
                        //tính số phần trăm từng phần
                        DecimalFormat df3456= new DecimalFormat("0.0");// làm tròn với 3chữ số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                    ...
                    case 7:
                        ...
                        //tính số phần trăm từng phần
                        DecimalFormat df34567= new DecimalFormat("0.0");// làm tròn với 3chữ số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double
                    ...
                    case 8:
                        ...
                        //tính số phần trăm từng phần
                        DecimalFormat df345678= new DecimalFormat("0.0");// làm tròn với 3chữ số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double
                    ...
                    case 9:
                        ...
                        //tính số phần trăm từng phần
                        DecimalFormat df3456789= new DecimalFormat("0.0");// làm tròn với 3chữ số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double
