package com.example.buoi1_bai2_dang_b1609515;
...
public class MainActivity extends AppCompatActivity {
    Button btnmenu, btnpopup, thoat; // Khai báo các đối tượng loại Button
    @Override
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.item1:
                ...
                Typeface t=Typeface.create("serif",Typeface.BOLD); // Chọn kiểuchữ.
...
//Lập trình hành động khi chọn item.
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.item3_1: btnpopup.setText("MENU COPY");// Đổi tên nút menu.
                        break;
                }
                switch (item.getItemId()) {
